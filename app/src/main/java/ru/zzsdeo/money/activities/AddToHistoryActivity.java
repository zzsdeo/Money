...
public class AddToHistoryActivity extends ActionBarActivity
        implements
    ...
    private ScheduledTransactionCollection scheduledTransactionCollection;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        assert bundle != null;
        scheduledTransactionId = bundle.getLong(NeedConfirmRecyclerViewAdapter.SCHEDULED_TRANSACTION_ID);
        scheduledTransactionCollection = new ScheduledTransactionCollection(this);
        ScheduledTransaction transaction = scheduledTransactionCollection.get(scheduledTransactionId);
        ...
        addBtn.setText("Подтвердить и добавить в историю");
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.addBtn:
                ...
                removeItem(scheduledTransactionId);
    ...
    private void removeItem(long id) {
        ScheduledTransaction transaction = scheduledTransactionCollection.get(id);
        if (transaction.getDestinationAccountId() != 0) {
            ...
            scheduledTransactionCollection.removeScheduledTransaction(linkedId);
        }
